...
商品に「Cherry MX対応」「Cherry MX互換軸用」「MXスイッチ互換軸対応」みたいな説明書きが付いている場合はだいたい大丈夫です。
...
キーキャップを引き抜く場合は、まっすぐに引き抜いてください。

キーキャップと一緒にスイッチが抜けることもあります。その場合はまっすぐに差し直してください。
差し直しの際に金属のツメが曲がってしまうとキー入力ができなくなります。そんな感じになったらツメをまっすぐになるように伸ばしてから差し直してください。
ツメが折れてしまった場合、千葉千夏までご相談ください。

専用のキーキャップ引き抜き工具があるといいです。下記のものはキースイッチの引き抜き工具と一体になっているのでお得です。
